  ...
  >
    <div className="flex flex-col xl:flex-row h-auto xl:h-137.5 border border-none text-center">
      ...
      <div className=" xl:flex w-full mb-10 relative overflow-hidden p-12 flex-col justify-center">
        ...
        <KioskButton
          onClick={onStart}
          className="w-full bg-(--pp-brand-primary) hover:bg-(--pp-brand-primary-dark) text-white px-10 py-8 rounded-3xl font-black text-3xl flex items-center justify-center gap-4 transition-all hover:translate-x-2 shadow-xl shadow-blue-900/20 font-varela-round"
        >
