  ...
  return (
    ...
    >
      <div className="kiosk-card bg-white w-full max-w-full rounded-4xl p-10 sm:p-12 shadow-2xl shadow-slate-200/50 border border-slate-200 relative">
        ...
        <div className="p-8 bg-(--pp-brand-primary) rounded-3xl shadow-xl shadow-blue-900/10 flex flex-col xl:flex-row xl:items-center justify-between gap-8 text-white relative overflow-hidden border-b-8 border-(--pp-brand-accent)">
