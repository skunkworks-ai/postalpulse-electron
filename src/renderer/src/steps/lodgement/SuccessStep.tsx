    ...
    >
      <div className="text-center space-y-4">
        ...
        <div className="space-y-1">
          ...
          <p className="kiosk-subtext text-emerald-500 font-semibold text-sm uppercase tracking-widest">
            {copy.subtitle}
          </p>
          <p className="kiosk-subtext text-slate-400 w-150 mt-5 text-sm tracking-widest">
            {copy.description}
          </p>
        </div>
      </div>
      ...
      <div className="kiosk-card grid grid-cols-1 xl:grid-cols-2 gap-8 w-full">
        <motion.div
          ...
          className="bg-white p-10 rounded-4xl border border-slate-200 shadow-xl shadow-slate-200/50 relative overflow-hidden group flex flex-row items-start"
        >
          <div className="absolute -top-10 -right-10 opacity-5 group-hover:opacity-10 transition-opacity rotate-12">
            <Printer size={200} />
          </div>
          <div className="text-(--pp-brand-accent) me-4">
            <Printer size={60} />
          </div>
          <div>
            <h4 className="text-2xl font-black text-(--pp-brand-primary) uppercase tracking-tighter">
              {copy.retrieveTag}
            </h4>
