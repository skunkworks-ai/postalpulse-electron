const en = {
  ...
  steps: {
    ...
    verify: {
      ...
      box: 'Box',
      total: 'Total',
      selectRate: 'Select a shipping option',
      loadingRates: 'Loading shipping rates...',
      ratesError: 'Unable to load shipping rates. Please try again.',
      retryRates: 'Retry',
      noRates: 'No shipping rates available for this route.',
